  ...
  function (ko, Context, moduleUtils, KnockoutTemplateUtils, CoreRouter, ModuleRouterAdapter, KnockoutRouterAdapter, UrlParamAdapter, ResponsiveUtils, ResponsiveKnockoutUtils, ArrayDataProvider) {
    ...
    function ControllerViewModel() {
      ...
      let navData = [
        ...
        { path: 'kycdocuments', detail: { label: 'Kycdocuments', iconClass: 'oj-ux-ico-contact-group' } },
        { path: 'listCustomers', detail: { label: 'List Customers', iconClass: 'oj-ux-ico-information-s' } },
        { path: 'customerDetails', detail: { label: 'Customer Profile', iconClass: 'oj-ux-ico-contact-group' } },
      ...
      this.appName = ko.observable("Customer Dashboard");
      // User Info used in Global Navigation area
      this.userLogin = ko.observable("vaishnavi.vangireddy@oracle.com");
